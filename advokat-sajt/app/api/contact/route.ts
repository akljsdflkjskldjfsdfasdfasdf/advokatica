...
export async function POST(req: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      from: `"Maja Mrdjen | Advokat" <${process.env.GMAIL_USER}>`,
      to: email,
      subject: `Potvrda prijema poruke — Maja Mrdjen Advokat`,
      html: `
        <!DOCTYPE html>
        <html>
        <head><meta charset="utf-8"></head>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#0d0c0a;padding:40px 20px;">
            <tr><td>
              <table width="600" cellpadding="0" cellspacing="0" style="margin:0 auto;background:#161411;border:1px solid #b8952a;">
                <tr>
                  <td style="padding:40px;border-bottom:1px solid #2e2b26;">
                    <p style="color:#b8952a;font-size:11px;letter-spacing:0.3em;text-transform:uppercase;margin:0 0 12px 0;">Maja Mrdjen | Advokat</p>
                ...
                <tr>
                  <td style="padding:40px;">
                    ...
                    <p style="color:#b8952a;font-size:13px;margin:0;">Maja Mrdjen, advokat<br>
